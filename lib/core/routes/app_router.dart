...
import '../../features/admin/admin_product_enquiries_screen.dart';
import '../../features/admin/admin_profile_screen.dart';
import '../../features/admin/admin_sales_reports_screen.dart';
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
          ...
          builder: (_, __) => const AdminProductEnquiriesScreen()),
      GoRoute(
          path: '/admin/reports',
          builder: (_, __) => const AdminSalesReportsScreen()),
      GoRoute(
          path: '/admin/profile',
