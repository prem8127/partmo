...
class InvoiceService {
  static const companyName = 'AXIONDRIVE AUTO SOLUTIONS PRIVATE LIMITED';
  static const gstNumber = '37ABFCA6002KIZR';
  ...
  static Future<void> downloadInvoiceImage(InvoiceData data) async {
    final bytes = await buildInvoice(data);
    await for (final page
        in Printing.raster(bytes, pages: const [0], dpi: 160)) {
      final png = await page.toPng();
      await Printing.sharePdf(
        bytes: png,
        filename: 'PartMo_Invoice_${_safeFilePart(data.orderId)}.png',
        subject: 'PartMo invoice ${data.orderId}',
      );
      return;
    }
  }
    ...
    return pw.Column(
      ...
      children: [
        ...
        pw.Row(
          mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
          children: [
            pw.Text('$companyName  |  GST: $gstNumber',
                style: const pw.TextStyle(color: _muted, fontSize: 8)),
