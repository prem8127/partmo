...
class _AdminOrdersScreenState extends State<AdminOrdersScreen> {
  ...
  Future<void> _changeStatus(
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          content: Text(result.statusSaved
                    ...
                    if (nextStatus != null) ...[
                      ...
                      Expanded(
                        ...
                        child: FilledButton.icon(
                          ...
                          label: Text(OrderStatus.label(nextStatus),
                              overflow: TextOverflow.ellipsis),
                        ),
                      ),
                    ],
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Order Control',
                style: TextStyle(
                    color: AppPalette.navy,
                    fontSize: 20,
                    fontWeight: FontWeight.w900)),
            const SizedBox(height: 4),
            const Text('Update fulfilment and delivery information.',
            ...
            DropdownButtonFormField<String>(
              ...
              items: [
                for (final status in statusOptions)
                  DropdownMenuItem(
                      value: status, child: Text(OrderStatus.label(status))),
              ],
            ...
            SizedBox(
              ...
              child: FilledButton(
                ...
                child: const Text('Save order update',
