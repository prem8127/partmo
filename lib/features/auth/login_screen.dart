            ...
            children: [
              if (!sent) ...[
                const Text(
                  ...
                  style: TextStyle(
                      color: Color(0xFF4E6070), fontSize: 12.5, height: 1.4),
                ),
                    ...
                    children: [
                        ...
                        children: [
                          Expanded(
                              child: _PrecisionTile(
                                  label: 'OEM PRECISION', icon: Icons.blur_on)),
                          SizedBox(width: 42),
                          Expanded(
                              child: _PrecisionTile(
                      ...
                      const Wrap(
                        ...
                        children: [
                          ...
                          Text('*',
                              style: TextStyle(
                                  color: Color(0xFF9CA8B4), fontSize: 9)),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(
                color: Color(0x30073B63), blurRadius: 12, offset: Offset(0, 5))
          ]),
        ...
        Container(
          ...
          child: Stack(
            children: [
              ...
              Center(
                  child: Icon(icon,
                      color: Colors.white.withOpacity(.34), size: 72)),
            ],
          ),
        ),
        const SizedBox(height: 14),
