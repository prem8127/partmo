      ...
      floatingActionButton: Column(
        ...
        children: [
          FloatingActionButton.extended(
            ...
            onPressed: () async {
              final uri = Uri.parse(
                  'https://wa.me/919010907444?text=${Uri.encodeComponent('Hello PartMo, I need help with a product enquiry.')}');
            ...
            label: const Text('PRODUCT ENQUIRY',
                style: TextStyle(
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      padding: EdgeInsets.fromLTRB(
          12, MediaQuery.paddingOf(context).top + 12, 12, 12),
      child: Row(
        children: [
          IconButton(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            // Background gear icon watermark
            Positioned(
              right: -10,
              top: -14,
              child: Icon(Icons.settings,
                  color: Colors.white.withOpacity(.07), size: 110),
            ),
            Padding(
            ...
            children: [
                      ...
                      children: [
                        const Expanded(
                          child: Padding(
                            ...
                            child: Text('Part Name / Number / Brand',
                                style: TextStyle(
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child:
                      const Icon(Icons.tune, color: AppPalette.navy, size: 24),
                ),
              ),
            ],
          ),
...
class _HeroSlideBrand extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: AppPalette.navy, borderRadius: BorderRadius.circular(7)),
      child: Stack(
        children: [
          Positioned(
            right: -6,
            ...
            child: Transform.rotate(
              ...
              child: Icon(Icons.directions_car_filled,
                  color: Colors.white.withOpacity(.20), size: 122),
            ),
          ),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
    ...
    return Container(
      ...
      child: const Row(
        children: [
          Expanded(
              child: _TrustBadge(
                  icon: Icons.local_shipping, label: 'FREE DELIVERY')),
          SizedBox(width: 10),
          Expanded(
          ...
          Expanded(
              child: _TrustBadge(
                  icon: Icons.currency_rupee, label: 'BEST PRICES')),
        ],
      ),
    );
  }
        ...
        children: [
          ...
          Row(
            ...
            children: [
              const Expanded(
                  child:
                      Text('Highly Rated Parts', style: _sectionHeadingStyle)),
              TextButton(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              const Expanded(
                  child:
                      Text('Browse by Category', style: _sectionHeadingStyle)),
              TextButton(
              ...
              child: const Row(
                ...
                children: [
                  ...
                  Icon(Icons.arrow_forward_ios,
                      size: 10, color: Color(0xFF008A9E)),
                ],
              ),
            ),
          ),
...
class _BrandCard extends StatefulWidget {
  const _BrandCard(
      {required this.label, this.logoAsset, this.gold = false, this.index = 0});
  final String label;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('Aftermarket & Local Brands',
        ...
        builder: (context) => Padding(
          ...
          child: Column(
            ...
            children: [
              Text(tag,
                  style: const TextStyle(
                      color: AppPalette.cyan, fontWeight: FontWeight.w900)),
              const SizedBox(height: 10),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(body,
                    ...
                    overflow: TextOverflow.ellipsis,
                    style: const TextStyle(
                        color: Color(0xFF657583), fontSize: 11, height: 1.2)),
              ],
            ),
          ),
        ]),
  ...
  Widget build(BuildContext context) {
    return _SectionShell(
      ...
      child: Column(children: [
        const Text('Why PartMo?',
            textAlign: TextAlign.center, style: _sectionHeadingStyle),
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      Text(text,
          textAlign: TextAlign.center,
          style: const TextStyle(
              color: Color(0xFF657583), fontSize: 10.5, height: 1.2)),
    ]);
  }
}
            ...
            children: [
              ...
              Row(children: [
                CircleAvatar(
                  ...
                  child: Text('RK',
                      style: TextStyle(
                          color: AppPalette.navy, fontWeight: FontWeight.w900)),
                ),
                SizedBox(width: 12),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [
          BoxShadow(
              color: Color(0x30073B63), blurRadius: 18, offset: Offset(0, 6)),
        ],
      ),
      child: Row(
        children: [
                ...
                GestureDetector(
                  onTap: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content:
                            Text('Opening mail to precisiong@gmail.com...'),
            ...
            children: [
              ...
              Container(
                ...
                child: const Icon(Icons.inventory_2_outlined,
                    color: Color(0xFFB8D3E6), size: 22),
              ),
            ],
          ),
        ],
    ...
    return Container(
      ...
      child: Column(children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          _StoreButton(icon: Icons.play_arrow, label: 'GET IT ON\nGoogle Play'),
          const SizedBox(width: 12),
        ...
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Expanded(
              child: _FooterLinks(title: 'SUPPORT', links: [
            'FAQs',
            'Return Policy',
            'Shipping Info',
            'Terms of Service'
        ...
        const Text('© 2026 PartMo. All rights reserved.',
            style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        width: 116,
        decoration: BoxDecoration(
            color: AppPalette.navy, borderRadius: BorderRadius.circular(5)),
...
class _SectionShell extends StatelessWidget {
  const _SectionShell(
      {required this.child, this.topPadding = 0, this.bottomPadding = 28});
  final Widget child;
