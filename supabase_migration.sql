...
create policy "Admins can view all profiles" on public.profiles for select using (auth.jwt() ->> 'email' = 'admin@precisionparts.com');
...
create policy "Anyone can view active banners" on public.banners for select using (is_active = true or auth.jwt() ->> 'email' = 'admin@precisionparts.com');
create policy "Admins can manage banners" on public.banners for all using (auth.jwt() ->> 'email' = 'admin@precisionparts.com') with check (auth.jwt() ->> 'email' = 'admin@precisionparts.com');
